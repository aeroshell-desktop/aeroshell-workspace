...
Mimetype association overrides are installed at `/usr/local/share/mime/packages/`, and needs to be updated by running the following command after installation:
